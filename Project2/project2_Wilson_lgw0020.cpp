/* FILE NAME: project2_Wilson_lgw0020.cpp
 * AUTHOR: Laura Wilson
 * version: 2/2/2022
 * compile: g++ project2_Wilson_lgw0020.cpp
 * 
 * run: ./a.out project2_Wilsonlgw0020.cpp
 *  Outside sources: none used
 */ 
...
int main() {
    ...
    cout << "*** Welcome to Laura's Duel Simulator ***\n";
    // Unit Testing
